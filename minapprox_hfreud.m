function[a] = minapprox_hfreud(alph, rho, n)
% a = mixapprox_hfreud(alph, rho, n)
%
% Returns a guess for the left-hand side of the support interval for
%
